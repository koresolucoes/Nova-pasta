...
import { DashboardIcon, CampaignIcon, ContactsIcon, TemplatesIcon, SettingsIcon, PaperAirplaneIcon, TableCellsIcon, FlowsIcon, ChatBubbleOvalLeftEllipsisIcon, SparklesIcon } from '../src/components/icons';
